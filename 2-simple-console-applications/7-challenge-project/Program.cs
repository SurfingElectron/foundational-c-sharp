...
foreach (string name in studentNames)
{
    ...
    // variables to track and calculate the parts of exam and extra credit scores
    int sumExamScores = 0;
    ...
    */
    ...
    currentStudentExtraCreditPoints = (decimal) ((decimal) sumExtraCreditScores / 10) / examAssignments;
